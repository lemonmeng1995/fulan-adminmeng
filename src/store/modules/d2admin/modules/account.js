...
import { AccountLogin } from '@/api/modules/sys.user'
  ...
  actions: {
    ...
    async login({ dispatch }, data) {
      ...
      if (res.code === '0' ) {
        ...
        // // 设置 vuex 用户信息
        await dispatch('d2admin/user/set', { name: data.username }, { root: true })
    ...
    logout({ commit, dispatch }, { confirm = false } = {}) {
      ...
      if (confirm) {
        ...
        MessageBox.confirm('确定要退出当前账号吗', '退出登录', { type: 'warning' })
          .then(() => {
